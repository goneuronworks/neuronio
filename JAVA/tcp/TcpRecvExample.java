...
public class TcpRecvExample {
	...
	private static void sendHexMessage(){   	
    	try {
    		//response protocol.
    		//<T000000077Hello, World      >
    		String STX = "<";
			...
			try {
				...
				System.out.println("Send Hex Message : " + sendMessage + " / " + encryptData);
			} catch (InvalidKeyException | NoSuchAlgorithmException | NoSuchPaddingException
					| InvalidAlgorithmParameterException | IllegalBlockSizeException | BadPaddingException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	    	//toServer.write(hexMessage);
		} 
    	catch (IOException e) {
			e.printStackTrace();
		}
